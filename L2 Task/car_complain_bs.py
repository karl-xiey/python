# -*- coding: utf-8 -*-
"""
Created on Sat Feb 13 18:32:39 2021
...
def analysis(soup):
    ...
    for tr in tr_list:
        ...
        if len(td_list)>0:
            ...
            id,brand,car_model,type,desc,problem,datetime,status=td_list[0].text,\
            td_list[1].text,td_list[2].text,td_list[3].text,td_list[4].text,td_list[5].text,\
